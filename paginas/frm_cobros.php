    ...
    <div class="container">
        <header>
            <ul class="nav nav-tabs justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="frm_cobros.php">Cobros</a>
                </li>
            </ul>
        </header>
            ...
            <div class="col col-4">
                ...
                <form action="../objetos/objeto_cobros.php" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" id="txtBonificacion" name="txtBonificacion" class="form-control" placeholder="Ingrese bonificación">
                    </div>
                    <div class="mb-3">
                        <label for="txtComisionCobro" class="form-label">Comision Cobro</label>
                        <input type="number" id="txtComisionCobro" name="txtComisionCobro" class="form-control" placeholder="Ingrese comisión">
                    </div>
                    <div class="mb-3">
